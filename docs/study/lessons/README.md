...
**[교재 안내와 다운로드](../pptx_textbook/output/START_HERE.html)**에서 공통 기초·Protobuf, 서버, Unreal 교재를 고릅니다. PPT와 전체 해설 HTML을 함께 제공합니다. 기존 S01의 실제 진도는 변경하지 않았습니다.

## 하루 집중 교재 — 2026-09-08 현재 코드 기준

**[브라우저로 읽기](./D01-one-day-project-guide.html)** · [Markdown 원문](./D01-one-day-project-guide.md)

Unreal 클라이언트 지원을 준비하며 프로젝트를 혼자 설명하는 하루 과정입니다. 읽을 파일·함수, 단위 계산, 최근 문제 해결 사례, 실행 없는 대체 실습, 접힌 정답을 포함합니다. 아래 S01 진도와 별도이며, 이 자료를 만들었다고 학습을 완료한 것은 아닙니다.
