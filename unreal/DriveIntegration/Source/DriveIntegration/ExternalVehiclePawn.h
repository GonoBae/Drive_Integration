...
protected:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="Vehicle") TArray<TObjectPtr<UStaticMeshComponent>> WheelMeshes;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SimCore|Presentation", meta=(ClampMin="0.0", ClampMax="0.1")) float MaxExtrapolationSeconds = 0.05f;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SimCore|Presentation", meta=(ClampMin="0.0", ClampMax="0.5")) float VisualWheelStopSpeedMps = 0.05f;
private:
