...
NPC/pedestrian collision inputs are recorded, not re-generated by offline AI.
"""
...
from smoke_signal_city import build_spec, connect_child
...
def main():
    ...
    with (output / (stem + ".stdout.log")).open("xb") as stdout, \
        ...
        process = subprocess.Popen(capture, cwd=ROOT, stdout=stdout, stderr=stderr,
